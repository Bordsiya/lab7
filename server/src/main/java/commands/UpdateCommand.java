...
public class UpdateCommand extends AbstractCommand{
    ...
    public boolean execute(String str, Object arg, User user) {
        try{
            ...
            if(oldSpaceMarine == null) throw new SpaceMarineNotFoundException("Не найден космический корабль с таким ID");
            if(!oldSpaceMarine.getCreator().equals(user)) throw new PermissionDeniedException("Ошибка доступа к объектам, недостаточные права");
